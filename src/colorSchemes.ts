...
export const COLOR_SCHEMES_LIGHT: Record<string, ColorSchemeMap> = {
  ...
  sunset: {
    ...
    'useimperativehandle': '#E65100', // 深橙 → 句柄
    'usedebugvalue': '#C62828',    // 深红 → 调试
    'usedeferredvalue': '#BF360C', // 深红橙 → 延迟值
    'usetransition': '#D84315',    // 深橙红 → 过渡
    'useid': '#F57C00',            // 琥珀 → ID
    'usesyncexternalstore': '#FF6F00', // 琥珀 → 外部同步
    'useinsertioneffect': '#E64A19', // 橙红 → 插入副作用
    'region': '#689F38',           // 橄榄绿 → 区域
    'component': '#5D4037',        // 棕色 → 组件
    'handler': '#B71C1C',          // 深红 → 事件处理
